# LexO-server (v0.1)
## _A set of REST services for Linguistic Linked Data_ [![N|Solid](images/poweredILC4CLARIN.png)](https://ilc4clarin.ilc.cnr.it/)

[![Build Status](images/build-passing.png)]()
