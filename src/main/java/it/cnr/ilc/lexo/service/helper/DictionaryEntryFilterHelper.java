 ...
 */
public class DictionaryEntryFilterHelper extends TripleStoreDataHelper<DictionaryEntryItem> {

    @Override
    public void fillData(DictionaryEntryItem data, BindingSet bs) {
    ...
    @Override
    public Class<DictionaryEntryItem> getDataClass() {
