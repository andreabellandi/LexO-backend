 ...
 */
@ApiModel(description = "Output model representing label and IRI of a linked entity by a bibliography")
public class LinkedEntityByBibliography extends Entity implements Data {
